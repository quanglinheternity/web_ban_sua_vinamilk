...
<head>
    ...
    <!-- font -->
    <link rel="stylesheet" href="{{ asset('/assets/assets_font/fonts/fonts.css') }}">
    <link rel="stylesheet" href="{{ asset('/assets/assets_font/fonts/font-icons.css') }}">
    <link rel="stylesheet" href="{{ asset('/assets/assets_font/css/bootstrap.min.css') }}">
...
{{-- show --}}
        {{-- <link rel="stylesheet" href="{{ asset('/resources/js/showProduct.js')}}"> --}}
