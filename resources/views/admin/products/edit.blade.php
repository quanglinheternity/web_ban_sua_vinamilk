...
<div class="container mt-4">
    ...
    <form action="{{ route('admin.products.update' , $product->id ) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3 col-md-6">
            ...
            <input type="text" name="ten_san_pham" class="form-control @error('ten_san_pham') is-invalid @enderror" value="{{ old('ten_san_pham',$product->ten_san_pham) }}" >
        ...
        <div class="mb-3 col-md-6">
            ...
            <input type="" name="gia" class="form-control @error('gia') is-invalid @enderror" value="{{ old('gia' , $product->gia) }}"  step="0.01" min="0" >
            @error('gia') <div class="text-danger">{{ $message }}</div> @enderror
        </div>
        <div class="mb-3 col-md-6">
            <label class="form-label ">Giá khuyến mãi</label>
            <input type="number" name="gia_khuyen_mai" class="form-control @error('gia_khuyen_mai') is-invalid @enderror" value="{{ old('gia_khuyen_mai' ,$product->gia_khuyen_mai) }}" min="0">
        ...
        <div class="mb-3 col-md-6">
            ...
            <input type="number" name="so_luong" class="form-control @error('so_luong') is-invalid @enderror " value="{{ old('so_luong' , $product->so_luong) }}" step="0.01" min="0" >
        ...
        <div class="mb-3 col-md-6">
            ...
            @enderror" value="{{ old('ngay_nhap', $product->ngay_nhap) }}"  >
            @error('ngay_nhap') <div class="text-danger">{{ $message }}</div> @enderror
        </div>
        <div class="mb-3 col-md-12">
            <label class="form-label">Trạng thái</label>
            <select name="trang_thai" class="form-control" required>
                <option value="1" {{ old('trang_thai', $product->trang_thai) == 1 ? 'selected' : '' }}>Hoạt động</option>
                <option value="0" {{ old('trang_thai', $product->trang_thai) == 0 ? 'selected' : '' }}>Tạm ngừng</option>
            </select>
